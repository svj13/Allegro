...
Atom = [^\s|;]+
SemiColon = ";"
ScaleType = "major"|"minor"|"melodic minor"|"mel minor"|"ionian"|"dorian"|"phrygian"|"lydian"|"mixolydian"|"aeolian"|"locrian"|"blues"|"major pentatonic"|"minor pentatonic"|"harmonic minor"|"harm minor"
PlayStyle = "arpeggio"
