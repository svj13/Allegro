...
<YYINITIAL> {
    ...
    "pentatonic scale"  {return symbol(DslSymbol.COMMAND_PENTATONIC_SCALE_NOTE);}
    "pentatonic midi scale" {return symbol(DslSymbol.COMMAND_PENTATONIC_SCALE_MIDI);}
    "play pentatonic scale" {return symbol(DslSymbol.COMMAND_PLAY_PENTATONIC_SCALE);}
